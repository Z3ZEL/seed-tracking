...
PARSER.add_argument("--calibrate", type=str, help="Enter in calibration mode, you need to give two input to --input arg separated by coma of the pictures of the master and the slave camera", required=False, default=None, dest="calibrate")
