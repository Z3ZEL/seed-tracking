...
if not(CONFIG["production"]):
    ...
    PARSER.add_argument("--dev", type=str, help="Launch the server in test mode for development only. The device will be a mock one, meaning it won't use the real device, it produces fake data.", required=False)
